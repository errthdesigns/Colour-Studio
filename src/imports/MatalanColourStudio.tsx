...
function Canvas() {
  return (
    <div className="absolute h-[150px] left-0 opacity-0 top-0 w-[300px]" data-name="Canvas">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src="2b130670b2340a84fee6ce9d032b885a8363de98.png" />
    </div>
  );
}
...
function Heading() {
  return (
    <div className="absolute h-[96px] left-[32px] top-0 w-[843.055px]" data-name="Heading 1">
      <p className="absolute font-['Inter:Light',sans-serif] font-light leading-[96px] left-[422px] not-italic text-[96px] text-center text-nowrap text-white top-px tracking-[-1.92px] translate-x-[-50%] whitespace-pre">OWN YOUR COLOUR</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="absolute h-[206px] left-[252.47px] top-[393px] w-[907.055px]" data-name="Container">
      <Heading />
    </div>
  );
}
